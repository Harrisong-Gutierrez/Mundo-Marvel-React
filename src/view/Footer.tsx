...
const Footer = () => {
  return (
    <div>
       <div>
        <div>
    <footer className="text-center lg:text-left bg-stone-900 text-gray-400">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-400">Angular</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-400">React</a>
        </p>
        <p className="mb-4">
          <a href="#!" className="text-gray-400">Vue</a>
        </p>
        <p>
          <a href="#!" className="text-gray-400">Laravel</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
        ...
        <p className="mb-4">
          <a href="#!" className="text-gray-400">Orders</a>
        </p>
        <p>
          <a href="#!" className="text-gray-400">Help</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className=" text-gray-600 text-center p-6 bg-gray-200">
